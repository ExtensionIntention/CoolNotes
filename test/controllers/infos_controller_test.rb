...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { Email: @info.Email, Message: @info.Message, Name: @info.Name } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { Email: @info.Email, Message: @info.Message, Name: @info.Name } }
